...
static constexpr char kDriverClass[] = "com/maaend/android/bridge/DriverClass";
static constexpr char kNativeBridgeClass[] = "com/maaend/android/bridge/NativeBridgeLib";

static jstring ping(JNIEnv *env, jclass clazz) {
    (void) clazz;
    return env->NewStringUTF("MaaEndBridge");
}
