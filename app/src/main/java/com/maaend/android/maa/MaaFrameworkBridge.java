package com.maaend.android.maa;
...
public final class MaaFrameworkBridge {
    ...
    private void connectAgentIfNeeded() throws IOException {
        ...
        String identifier = "maaend-android-" + UUID.randomUUID();
    ...
    private java.util.Map<String, String> buildPiEnv() {
        ...
        env.put("PI_CLIENT_NAME", "MaaEndAndroid");
    ...
    private String buildPiControllerJson() {
        try {
            ...
            controller.put("attach_resource_path", new org.json.JSONArray().put("./resource_adb"));
    ...
    private static String buildControllerConfig(File runtimeRoot, Context context) {
        ...
        try {
            ...
            if (agentPath.isFile()) {
                ...
                root.put("client_type", "MaaEndAndroid");
            }
