...
private val MaaEndShapes = Shapes(
    extraSmall = RoundedCornerShape(MaaEndDesignTokens.CornerRadius.inner),
    small = RoundedCornerShape(MaaEndDesignTokens.CornerRadius.inner),
    medium = RoundedCornerShape(MaaEndDesignTokens.CornerRadius.card),
    large = RoundedCornerShape(MaaEndDesignTokens.CornerRadius.card),
    extraLarge = RoundedCornerShape(MaaEndDesignTokens.CornerRadius.pill),
)
